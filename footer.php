                          ...
                          <div class="footer-contact">
                              <ul class="footer-info">
                                  ...
                                  <li class="item">
                                      ...
                                      <a href="tel:+918048976906"> +91 9820 82 3043 </a>
                                  </li>
                                  <li class="item">
                                      <span class="box-icon">
                                          <svg width="14" height="14" viewBox="0 0 14 14" fill="none"
                  ...
                  <div class="footer-inner-wrap s3">
                      <div class="footer-col-block inner-col">
                          ...
                          <div class="tf-collapse-content">
                              <ul class="footer-menu-list">
                                  ...
                                  <li>
                                      <a href="store-location.html">Products</a>
                                  </li>
                                  <li>
                      ...
                      <div class="footer-col-block inner-col">
                          ...
                          <div class="tf-collapse-content">
                              <ul class="footer-menu-list">
                                  <li>
                                      <a href="privacy-policy.html">Corporate Video</a>
                                  </li>
                                  <li>
                                      <a href="term-and-condition.html">Testimonial</a>
                                  </li>
                                  <li>
                                      <a href="return-and-refund.html">Quality & Compliance</a>
                                  </li>
                                  <li>
                                      <a href="faq.html">Product Portfolio</a>
                                  </li>
                                  <li>
                                      <a href="shipping.html">Corporate Presentation</a>
                                  </li>
                                  <li>
                                      <a href="store-location.html">Download Brochure</a>
                                  </li>
          ...
          <div class="footer-bottom">
              <div class="container">
                  <div class="footer-bottom-wrap">
                      <p class="text-dark">Copyright © 2025 by <span class="fw-medium">Shivam Industries.</span>
                          All
                          Rights
                          Reserved.</p>
                      <ul class="tf-payment">
                          <p class="text-dark">Designed by <span class="fw-medium">Technofra.</span> </p>
      ...
      <div class="mb-canvas-content">
          <div class="mb-body">
              ...
              <div class="mb-other-content">
                  ...
                  <div class="mb-notice">
                      <a href="contact-us.html" class="text-need">Contact Us</a>
                  </div>
                                  ...
                                  <div class="swiper-wrapper">
                                          ...
                                          <div class="card-product style-4">
                                              <div class="card-product-wrapper radius-16 line-2 asp-ratio-0">
                                                  ...
                                                  <ul class="list-product-btn">
                                                      ...
                                                      <li>
                                                          <a href="javascript:void(0);"
                                                              class="btn-quickview bg-surface hover-tooltip tooltip-left box-icon quickview">
                                                      ...
                                                      <li class="compare">
                                                          <a href="javascript:void(0);"
                                                              class="btn-compare bg-surface hover-tooltip tooltip-left box-icon">
                                              ...
                                              <div class="card-product-info  text-center">
                                                  <a href="product-detail.html"
                                                      class="name-product link fw-medium text-md">Moonlight
                                                      - iPhone 16
                                                      Case</a>
                                                  ...
                                                  <ul
                                                      ...
                                                      <li class="list-color-item color-swatch">
                                                          <span class="text-quantity font-2">iPhone</span>
                                                          <img class="lazyload"
                                                              data-src="images/products/phonecase/product-1.jpg"
                                                              src="images/products/phonecase/product-1.jpg"
                                                              alt="image-product">
                                                      ...
                                                      <li class="list-color-item color-swatch">
                                                          <span class="text-quantity font-2">Silicone</span>
                                                          <img class="lazyload"
                                      ...
                                      <div class="swiper-slide">
                                          <div class="card-product style-4">
                                              ...
                                              <div class="card-product-info text-center">
                                                  <a href="product-detail.html"
                                                      class="name-product link fw-medium text-md">Heatwave -
                                                      iPhone 16
                                                      Case</a>
                                                  <p class="price-wrap fw-medium">
                                                  ...
                                                  <ul
                                                      ...
                                                      <li class="list-color-item color-swatch">
                                                          <span class=" text-quantity font-2">Metal</span>
                                                          <img class=" lazyload"
                                                              data-src="images/products/phonecase/product-2.jpg"
                                                              src="images/products/phonecase/product-2.jpg"
                                                              alt="image-product">
                                      ...
                                      <div class="swiper-slide">
                                          <div class="card-product style-4">
                                              <div class="card-product-wrapper radius-16 line-2 asp-ratio-0">
                                                  <a href="product-detail.html" class="product-img">
                                                      <img class="img-product lazyload"
                                                          ...
                                                          alt="image-product">
                                                      <img class="img-hover lazyload"
                                                          data-src="images/products/phonecase/product-5.jpg"
                                                          src="images/products/phonecase/product-5.jpg"
                                                          alt="image-product">
                                                  </a>
                                                  <!-- <div class="on-sale-wrap"><span class="on-sale-item ">20% Off</span>
                                                    </div> -->
                                              ...
                                              <div class="card-product-info  text-center">
                                                  <a href="product-detail.html"
                                                      class="name-product link fw-medium text-md">Peachy -
                                                      iPhone 13 Pro
                                                      Case</a>
                                                  <p class="price-wrap fw-medium">
                                      ...
                                      <div class="swiper-slide">
                                          <div class="card-product style-4">
                                              ...
                                              <div class="card-product-info text-center">
                                                  <a href="product-detail.html"
                                                      class="name-product link fw-medium text-md">Morning
                                                      Commute</a>
                                                  <p class="price-wrap fw-medium">
              ...
              <div class="tf-product-media-wrap">
                  <div dir="ltr" class="swiper tf-single-slide">
                      <div class="swiper-wrapper">
                          <div class="swiper-slide">
                              <div class="item">
                                  <img class="lazyload" data-src="images/products/phonecase/product-1.jpg"
                                      src="images/products/phonecase/product-1.jpg" alt="">
                              </div>
                          </div>
                          <div class="swiper-slide">
                              <div class="item">
                                  <img class="lazyload" data-src="images/products/phonecase/product-2.jpg"
                                      src="images/products/phonecase/product-2.jpg" alt="">
                              </div>
                          </div>
                          <div class="swiper-slide">
                              <div class="item">
                                  <img class="lazyload" data-src="images/products/phonecase/product-4.jpg"
                                      src="images/products/phonecase/product-4.jpg" alt="">
                              </div>
                          </div>
                      </div>
              ...
              <div class="tf-product-info-wrap">
                  <div class="tf-product-info-inner">
                      <div class="tf-product-heading">
                          <h6 class="product-name"><a href="product-detail.html" class="link">Heatwave - iPhone
                                  16 Case</a></h6>
